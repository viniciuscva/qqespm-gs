...
class SpatialPatternGraph:
    ...
    def plot_structure(self, output_file = None, positions = None, dpi = 85, node_color = 'k', edge_color = 'k', ax = None, 
             figwidth = 21, figheight = 7, xlim = (-1.03, 1.35), ylim = (-1.05, 1.15), node_size=400, edge_width=3.0):
...
def is_qq_e_match(ilq: ILQuadTree, os, ot, edge: SpatialEdge, metric):
...
def compute_qq_e_matches_for_an_edge_parallel(ilq: ILQuadTree, edge, qq_n_matches_for_the_edge, metric, candidate_objects = dict(), 
            pool_obj = None):
...
def compute_qq_e_matches_for_all_edges(ilq: remote_ilquadtree.RemoteILQuadtree, sp: SpatialPatternGraph, qq_n_matches: dict, metric, alternated, debug = True, pool_obj = None):
    ...
    non_skip_edges = [e for e in edges_order if e not in skip_edges]
